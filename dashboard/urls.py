...
from dashboard.views.dashboard_edit import import_query
from dashboard.views.dashboard_view import index, get_saved_query_result, \
...
urlpatterns = [
    ...
    url("^import_query$", import_query, name="import-query"),
]
